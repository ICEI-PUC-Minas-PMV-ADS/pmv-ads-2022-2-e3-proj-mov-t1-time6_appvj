...
A primeira funcionalidade desenvolvida foi a correspodente ao requisito funcional 013 (A aplicação deve permitir que o usuário faça login e acesse um campo para recuperar a senha e cadastr). 
